...
public static class GenerateWaterGrid
{
    ...
    public static Mesh GenerateMesh(Mesh mesh, float width, float resolution, float yOffset)
    {
        ...
        for (int y = 0; y <= ySize; y++)
        {
            ...
            for (int x = 0; x <= xSize; x++)
            {
                ...
                vertices[arrayPos] = new Vector3(xCoord, yOffset, yCoord);
